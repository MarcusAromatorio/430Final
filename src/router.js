...
var router = function(app){
	...
	app.get('/void', middleware.requiresLogin, controllers.VoidStare.sendRedirect);
	app.post('/void', controllers.VoidStare.sendResponse); // POST method from catcall page calls the "chat" method of the associated controller
